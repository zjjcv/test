...
def main():
    ...
    # Checkpoint 路径: results/checkpoint_transformer_2_4_128/x_minus_y/wd_1.0
    checkpoint_dir = os.path.join(base_dir, "results", "checkpoint_transformer_2_4_128", "x_minus_y", "wd_1.0")
    ...
    if not step_file_map:
        print("No valid checkpoints found for seed 42.")
        return
    ...
    print("Projecting historical trajectories...")
    for step in tqdm(sorted_steps):
    ...
    if all_data:
        ...
        save_path = os.path.join(output_dir, "pca_trajectory_wd1.csv")
